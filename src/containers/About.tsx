    ...
    <Wrapper id="about" {...getSectionAnimation}>
      ...
      <main className="flex flex-col items-center gap-16 lg:items-start lg:flex-row">
        <div className="space-y-4 lg:w-3/5">
          <p>
            Hi, my name is Vinit Kumar giri. I am a 2nd year btech student at{' '}
            <Link
            ...
            .<br /> B.Tech Computer Science student at GNIOT
Skilled in Python, Java, and C++
Strong foundation in data structures, algorithms, and OOP
Experience in web development
Knowledge of machine learning
Eager to learn, grow, and contribute as a valuable team member
          </p>
          <p>
